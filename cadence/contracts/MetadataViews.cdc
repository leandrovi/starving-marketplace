...
pub contract Metadata {
    ...
    pub struct NFTCollectionData {
        ...
        /// including standard NFT interfaces and Metadata interfaces
        ...
        /// `NFT.Receiver`, and `Metadata.ResolverCollection` interfaces are required.
        ...
        init(
            ...
            pre {
                publicLinkedType.isSubtype(of: Type<&{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, Metadata.ResolverCollection}>()): "Public type must include NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, and Metadata.ResolverCollection interfaces."
                providerLinkedType.isSubtype(of: Type<&{NonFungibleToken.Provider, NonFungibleToken.CollectionPublic, Metadata.ResolverCollection}>()): "Provider type must include NonFungibleToken.Provider, NonFungibleToken.CollectionPublic, and Metadata.ResolverCollection interface."
            }
